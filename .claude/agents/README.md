...
├── examples/                    # Claude AI patterns and references
...
Designs concise system prompts (100-300 words) that define agent behavior. Specializes in creating clear, effective prompts for Claude AI agents.

### **claude-ai-tool-integrator**
...
All agents are built using [Claude AI](https://ai.claude.dev/), providing:
